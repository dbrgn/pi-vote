...
namespace Pirate.PiVote.Client
{
  public class SignatureRequestDocument : PrintDocument
  {
    ...
    private void PrintRequest(RectangleF bounds)
    {
      ...
      requesterSign.SetCenterTop(bounds.Left + sixth, bounds.Top);
      requesterSign.Draw();
      ...
      firstAuthoritySign.SetCenterTop(bounds.Left + 3 * sixth, bounds.Top);
      firstAuthoritySign.Draw();

      SignObject secondAuthorityign = new SignObject(this.graphics, Resources.SigningRequestDocumentSignSecondAuthority, Resources.SigningRequestDocumentSignSignature, Resources.SigningRequestDocumentSignDate, font);
      secondAuthorityign.SetCenterTop(bounds.Left + 5 * sixth, bounds.Top);
      secondAuthorityign.Draw();
    }
    ...
    private void PrintResponse(RectangleF bounds)
    {
      ...
      caSign.SetCenterTop(bounds.Left + bounds.Width / 6f * 5f, bounds.Top);
      caSign.Draw();
    }
